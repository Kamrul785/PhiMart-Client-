...
const OrderCard = ({ order, onCancel }) => {
  ...
  const statusColors = {
    "Not Paid": "bg-gray-500 hover:bg-gray-600",
    "Ready To Ship": "bg-yellow-500 hover:bg-yellow-600",
        ...
        <div className="flex gap-2">
          {user.is_staff ? (
            <select
              ...
              className={`py-1 p-2 p rounded-full text-white text-sm font-medium ${statusColors[status]} focus:border-none focus:outline-none shadow-lg `}
            >
