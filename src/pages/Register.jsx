...
import { FiUser, FiMail, FiLock, FiPhone, FiMapPin, FiArrowRight, FiCheck } from "react-icons/fi";
      ...
      <div className="w-full max-w-2xl animate-fade-in-up">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100">
          ...
          <div className="bg-gradient-to-r from-teal-600 to-teal-700 px-6 py-8 sm:px-8 sm:py-10">
            ...
            <p className="text-teal-100">Join PhiMart and start shopping today</p>
          </div>
          ...
          <div className="px-6 py-8 sm:px-8">
            ...
            <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
              ...
              <p className="text-center text-xs text-gray-600">
                By creating an account, you agree to our <Link to="#" className="text-teal-600 hover:underline">Terms of Service</Link> and <Link to="#" className="text-teal-600 hover:underline">Privacy Policy</Link>
              </p>
            </form>
